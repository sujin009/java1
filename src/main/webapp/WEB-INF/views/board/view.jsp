...
<body>
	<div class="container">
		<br> <br> <br>
		<h1>
			<i class="fa fa-soundcloud"></i>&nbsp;Board View
		</h1>
		<br> <br> <br>
		<table class="table">
			<thead class="thead-dark">
				...
				<tr>
					<td colspan="2" class="text-left">
						...
						href="updateForm.do?no=${param.no }&perPageNum=${param.perPageNum}&key=${param.key}&word=${param.word}" class="btn btn-primary">수정</a>
			...
			<div class="modal-content">
				<form action="delete.do" method="post">
					...
					<div class="modal-body">
						<input class="form-control" placeholder="비밀번호 입력" name="pw" type="password">
					</div>
